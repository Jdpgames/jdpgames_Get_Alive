...
public class EnemyFire : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if (John != null) // si john no esta muerto, se cumple estas funciones.
        {
            ...
            if (distanceX < 4.0f && distanceY < 1.0f && Time.time > ColdDown + 0.75f) // la condicion del rango, si esta a menos de 4 y de altura 1 y no hay coldown, funcion shoot que es disparar.
      {
                shoot();
        ...
        void shoot()
        {
            ...
            if (Time.time > ColdDown + 0.75f) // si el tiempo ya es mayor a medio segundo instancia otra bala.
      {
